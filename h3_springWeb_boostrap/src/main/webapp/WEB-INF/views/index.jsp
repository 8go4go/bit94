...
<head>
    ...
    <!-- Custom CSS -->
    <link href="${rootPath}/resources/css/shop-homepage.css" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${rootPath}">Bit Auction</a>
            </div>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h4><a href="${rootPath}/products/item">First Product</a>
                                </h4>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; Bit Auction 2017</p>
                </div>
            </div>
        </footer>
