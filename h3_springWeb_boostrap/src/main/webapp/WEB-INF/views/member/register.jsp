				...
				<form class="form-horizontal" method="post" name="signup"
						...
						<div class="col-md-8 col-sm-9">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									placeholder="ID로 사용할 Email을 입력하세요" value="">
							</div>
						</div>
					</div>
						...
						<div class="col-md-5 col-sm-8">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									placeholder="5~15자리까지의 패스워드를 입력하세요" value="">
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-5 col-sm-8">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									placeholder="패스워드를 다시한번 입력하세요" value="">
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-5 col-sm-8">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									placeholder="핸드폰 번호를 입력하세요" value="">
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3">연락가능한 전화번호<br>
							</label>
						<div class="col-md-5 col-sm-8">
							<input type="text" class="form-control" name="contactnum2"
								id="contactnum2" placeholder="연락가능한 다른 전화번호를 입력하세요"
								value="">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3">사진<br>
							<small>(필수아님)</small></label>
						<div class="col-md-5 col-sm-8">
							<div class="input-group">
					...
					<div class="form-group">
						<div class="col-xs-offset-3 col-xs-10">
							...
							<input name="Cancel" type="submit" value="취소"
								class="btn btn-primary">	
						</div>
					</div>
				</form>
